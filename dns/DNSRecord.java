...
public class DNSRecord {
    ...
    private Instant record_construct_time;
    ...
    public DNSRecord(String name, int ttl, String class_str, String type_str, String data) {
        ...
        // set the class, type numbers, and time the record was constructed
        this.class_num = classStringToNum(class_str);
        this.type_num = typeStringToNum(type_str);
        this.record_construct_time = Instant.now();
    ...
    /**
     * 
     * @return the time when the record was constructed
     */

    public Instant getTime() {
        return record_construct_time;
    }
}
